...
public class OnlineMapsBingMapsElevationManager : OnlineMapsSinglePartElevationManager<OnlineMapsBingMapsElevationManager>
{
    ...
    public override void RequestNewElevationData()
    {
        ...
        int countX = VideoMap.width / s + 2;
        int countY = VideoMap.height / s + 2;
        ...
        VideoMap.projection.TileToCoordinates(bufferPosition.x - 1, bufferPosition.y - 1, VideoMap.zoom, out sx, out sy);
        VideoMap.projection.TileToCoordinates(bufferPosition.x + countX + 1, bufferPosition.y + countY + 1, VideoMap.zoom, out ex, out ey);
    ...
    protected override void Start()
    {
        ...
        VideoMap = gameObject.GetComponent<OnlineMaps>();
    }
